...
const Footer = () => {
    return (
        <footer className="px-6 divide-y dark:bg-gray-100 dark:text-gray-800">
            <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                <div className="lg:w-1/3">
                    ...
                    <p className='mt-6 mb-8 pr-7 sm:mb-12'>An online web platform where you can create, edit, upload, delete your notes/information privately and securely without any disturbancee <br />
                        Created by <span className='text-rose-500 font-semibold'>Aman Shukla</span></p>
                </div>
                <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="flex justify-start space-x-3">
                            ...
                            <a href='https://github.com/ssevena228' target='_blank' title="Instagram" className="flex items-center p-1">
                            ...
                            <a href='' target='_blank' title="Facebook" className="flex items-center p-1">
            ...
            <div className="py-6 text-sm text-center dark:text-gray-600">© 2026 mynotebook. All rights reserved.</div>
        </footer>
    )
}
