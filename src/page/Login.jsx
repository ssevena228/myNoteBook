...
function Login() {
    ...
    const changeHandler = (e) =>{
        console.log("{...loginUser , [e.target.name]: e.target.value}" , loginUser  )
            ...
            <div className="w-full max-w-md p-8 space-y-3 rounded-xl  dark:text-gray-800">
                ...
                >
                    ...
                    <div className="space-y-1 text-sm">
                        ...
                        onChange={changeHandler}
                        className="w-full px-4 py-3 outline-none border rounded-md dark:border-gray-300 dark:text-gray-800 focus:dark:border-rose-600" fdprocessedid="m9ofyf" />
