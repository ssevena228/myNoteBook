                ...
                <div className="container flex justify-between h-16 mx-auto">
                    ...
                    <div className="flex items-center md:space-x-4">
                        ...
                        {isLogin ? ( 
                            ...
                            <div className="h-12 w-12 text-center rounded-full border-2
                            border-gray-300" onClick={(e)=> setOpen(true)}>
                                
                                <img className="h-full w-full object-contain rounded-full" 
                    ...
                    (<Link to="/login" className="hidden px-6 py-2 font-semibold rounded lg:block dark:bg-rose-600 dark:text-gray-50" fdprocessedid="83yogu">Log in
                    </Link>
                      )}
